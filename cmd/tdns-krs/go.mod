module github.com/johanix/dzm/cmd/tdns-krs

go 1.24.0

replace (
	github.com/johanix/dzm/v0.x/dzm => ../../v0.x/dzm
...
require (
	...
	github.com/johanix/dzm/v0.x/dzm v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/johanix/tdns/v0.x/tdns/core v0.0.0-00010101000000-000000000000 // indirect
